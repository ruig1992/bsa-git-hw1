...
До речі, кому потрібна книга **Роберта Мартіна**, яка згадується в статті, можете [придбати її тут](http://www.yakaboo.ua/agile-software-development-principles-patterns-and-practices.html#.WSCKsGjyjIU).  
Рекомендую також його ще одну книгу - ["Чистий код"](http://www.yakaboo.ua/clean-code-a-handbook-of-agile-software-craftsmanship.html).
