...
![Коли буде готово: як не зруйнувати відносини в команді](https://s.dou.ua/storage-files/estimates-1-800.png)
...
> `@ruig1992`  
Дякую за гарну статтю! :+1: Дуже корисна інформація! Треба завжди пам'ятати про комунікацію між працівниками, бути дружньою командою однодумців, чути одне одного.  
Ну і про походи на природу (або інші розважальні заходи) теж не слід забувати - відпочивати корисно завжди! :wink:

> `@SergeLoboda`  
Все стороны должны отдавать себе отчет, что оценка - это **тоже работа**. И она требует какого-то адекватного времени, командных усилий, техник и т.д. Поэтому, все попытки оценить задачу «за 15 минут» должны пресекаться как безответственные. Разумеется, шаблонные, понятные вещи могут и не требовать много времени для оценки, но это уже опыт в конкретном проекте.

>> `@ruig1992`  
:+1: ... Дійсно, "за 15 хвилин" - це не зовсім серйозно. :hushed:  Для великих задач, звісно. :muscle:

> `@Юрій Марковцев`  
Чудова стаття, дякую! І радісно, що я не один такий - фанат **Стівена Кові**! :sunglasses:
